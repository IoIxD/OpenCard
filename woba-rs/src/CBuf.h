...
/**
 * Note from ioi: i would like to talk to whoever decided to make this weird mangled ass "CBuf" bullshit with a mixture c-style ass memcpy functions and C++ style concepts. whoever is responsible made it a fucking nightmare to directly port to rust. great christ why couldn't you have just used std::vector like a normal programmer. fuck.
 */
